...
model_urls = {
    ...
    'swin_base': 'https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_base_patch4_window7_224_22kto1k.pth',
    'swin_large': 'https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_large_patch4_window7_224_22kto1k.pth',
}
...
def window_reverse(windows, window_size: int, H: int, W: int):
    ...
    Returns:
        x: (B, H, W, C)
    """
    B = math.floor(windows.shape[0] / (H * W / window_size / window_size))
...
class SwinTransformer_ReID(nn.Module):
    ...
    def __init__(
        ...
        super(SwinTransformer_ReID, self).__init__()
...
def swin_transformer_tiny(**kwargs):
    return SwinTransformer_ReID(model_name='swin_tiny', **kwargs)


def swin_transformer_small(**kwargs):
    return SwinTransformer_ReID(model_name='swin_small', **kwargs)


def swin_transformer_base(**kwargs):
    return SwinTransformer_ReID(model_name='swin_base', **kwargs)


def swin_transformer_large(**kwargs):
    return SwinTransformer_ReID(model_name='swin_large', **kwargs)
